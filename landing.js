...
const selectLanguage = (langCode) => {
    ...
    switch(langCode) {
      ...
      case 'de':
        ...
        tekst12.textContent = "Kontaktiere uns";
        tekst13.textContent = "IN KONTAKT BLEIBEN";
        tekst14.textContent = "Gebärdensprachen sind universell. Unterrichten Sie sie und erleichtern Sie die Kommunikation mit gehörlosen und stummen Menschen auf der ganzen Welt. Treten Sie unserer Community bei und entdecken Sie die Gebärdensprachen der Welt!";
        tekst15.textContent = "Unsere position";
        tekst16.textContent = "Telefonnummer";
        tekst17.textContent = "E-Mail-Adresse";
        tekst18.placeholder = "Name";
        tekst19.placeholder = "Telefonnummer";
        tekst20.placeholder = "Nachricht";
        tekst21.textContent = "Eine Nachricht schicken";
        break;
      case 'it':
      ...
      case 'es':
        ...
        heder1.textContent = "Ejercicio";
        heder2.textContent = "Prueba";
        heder3.textContent = "Traducción";
        tekst1.textContent = "¡Tu guía de las lenguas de signos del mundo!";
        tekst2.textContent = "Diferentes países, diferentes lenguas de signos. Con Znakovito supera las barreras del idioma y aprende lengua de signos de cualquier país.";
        tekst3.textContent = "Empezar";
        tekst4.textContent = "Sordos y mudos";
        tekst5.textContent = "se casa con otra persona sordomuda";
        tekst44.textContent = "Alrededor de 466 millones de personas";
        tekst55.textContent = "En todo el mundo hay personas con discapacidad auditiva y tienen que utilizar el lenguaje de señas, lo que genera una gran barrera lingüística cuando viajan al extranjero.";
        tekst6.textContent = "Traducción de audio y texto.";
        tekst7.textContent = "Ya sea que utilice mensajes de voz, entrada de texto o archivos de audio, Znakovito ofrece traducción precisa al lenguaje de señas, adaptada a diferentes dialectos locales.";
        tekst8.textContent = "Cuestionario para dos";
        tekst9.textContent = "Siente la conexión con tu pareja, amigo o familiar a través de un cuestionario desafiante, donde se califican tus habilidades para aprender el lenguaje de señas.";
        tekst10.textContent = "Aprender a través de juegos";
        tekst11.textContent = "Explora nuestro cuestionario para un jugador que te permite aprender rápidamente nuevos lenguajes de señas mientras viajas al extranjero o te preparas para comunicarte en nuevos lugares.";
        tekst12.textContent = "Contáctenos";
        tekst13.textContent = "MANTENTE EN CONTACTO";
        tekst14.textContent = "Las lenguas de signos son universales. Enseñarles y facilitar la comunicación con personas sordas y mudas de todo el mundo. ¡Únete a nuestra comunidad y descubre las lenguas de signos mundiales!";
        tekst15.textContent = "Nuestra ubicación";
        tekst16.textContent = "Número de teléfono";
        tekst17.textContent = "Dirección de correo electrónico";
        tekst18.placeholder = "Nombre";
        tekst19.placeholder = "Número de teléfono";
        tekst20.placeholder = "Mensaje";
        tekst21.textContent = "Enviar un mensaje";
        break;
      default:
